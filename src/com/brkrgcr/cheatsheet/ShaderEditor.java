...
public class ShaderEditor extends EditText
{
	...
	private static final int COLOR_KEYWORD = Color.parseColor("#ef7c61");
	private static final int COLOR_BACKGROUND = Color.parseColor("#222000");
	private static final int COLOR_TEXT = Color.parseColor("#e9e4e5");
	private static final int COLOR_STRING = Color.parseColor("#bcd42a");	
	private static final int COLOR_BUILTIN = Color.parseColor("#4bb1b1");
	...
	private static final Pattern keywords = Pattern.compile(
		"\\b(attribute|Schema|const|uniform|varying|break|continue|"+
		"do|for|while|@if|@else|in|out|inout|float|int|void|bool|true|false|"+
		"lowp|@include|highp|precision|invariant|discard|return|mat2|mat3|"+
	...
	private static final Pattern builtins = Pattern.compile(
		"\\b(radians|degrees|function|create|cos|tan|asin|acos|atan|pow|"+
	...
	private static final Pattern stringValue = Pattern.compile("'(.*?)'");
	//(@(extends|section|if|foreach|for|while|yield|include))(\(?\b|\n)
		...
		try
		{
			...
			for( Matcher m = comments.matcher( e );
				...
				e.setSpan(
					...
					m.end(),
					Spannable.SPAN_EXCLUSIVE_EXCLUSIVE );
			for( Matcher m = stringValue.matcher( e );
					m.find(); )
					e.setSpan(
